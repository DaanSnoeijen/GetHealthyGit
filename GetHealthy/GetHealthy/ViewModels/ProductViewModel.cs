...
namespace GetHealthy.Models
{
    public class ProductViewModel
    {
        ...
        public ProductViewModel(string Naam, double Calorieën, double TotaleVetten, double VerzadigdeVetten, double Koolhydraten, double Suikers, double Eiwitten, double Zouten)
        {
            naam = Naam;
            calorieën = Calorieën;
